...
def append_steps_offsets(root: h5.Group, step: int):
    ...
    append_dataset(steps["PointOffsets"], (root["Points"].shape[0],))
    append_dataset(steps["CellOffsets"], (root["Types"].shape[0],))
    append_dataset(steps["ConnectivityIdOffsets"], (root["Connectivity"].shape[0],))
...
if __name__ == "__main__":
    ...
    for step in range(nsteps):
        ...
        append_temporal_unstructured_grid(root, step)
